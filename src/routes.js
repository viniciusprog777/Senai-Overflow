...
routes.post("/questions",questionValidator.create, questionControllers.store);
routes.put("/questions/:id", questionControllers.update);
routes.delete("/questions/:id", questionControllers.delete);


//rotas de answers
routes.post("/questions/:id/answers",answerValidator.create, answerControllers.store);
